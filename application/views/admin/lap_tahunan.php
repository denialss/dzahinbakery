                    ...
                    <div class="col-md-12">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                ...
                                <div class="col-12">
                                        <!-- Main content -->
                                        <div id="print_tahunan" class="invoice p-3 mb-3">
                                            <!-- title row -->
                                            <div class="row">
                                                <div class="col-12">
                                                    <h4>
                                        ...
                                        <button class="btn btn-success float-right" onclick="printContent('print_tahunan')"><i class="bi bi-print"></i> Print</button>
